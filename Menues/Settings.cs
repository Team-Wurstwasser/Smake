    ...
    public class Settings : RenderMenue
    {
        ...
        static void ChangeMaxFutter()
        {
            ...
            do
            {
                ...
                Console.WriteLine("╠════════════════════════════════════════════╣");
                Console.WriteLine(LanguageSystem.Get("settings.maxFoodLimit").Replace("{limit}", GameData.MaxFutterconfig.ToString().PadRight(17)));
                Console.WriteLine("╚════════════════════════════════════════════╝");
                ...
                if (int.TryParse(input, out int wert) && wert > 0)
                {
                    if (wert > GameData.MaxFutterconfig)
                    {
                        ...
                        Console.WriteLine("\n" + LanguageSystem.Get("settings.maxFoodTooHigh").Replace("{limit}", GameData.MaxFutterconfig.ToString()));
                        Console.ResetColor();
                    }
                    else
                    {
